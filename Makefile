#############################################################################
# Makefile for building: 3dS_01_2
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  3dS_01_2.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile 3dS_01_2.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 3dS_01_21.0.0
DISTDIR = /home/anaeijon/Dropbox/Workspaces/3D_Scanning/Exercise_1/.tmp/3dS_01_21.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lSDL2 -lGLEW -lGLU -lQt5OpenGL -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = source/GLcamera.cpp \
		source/GLwidget.cpp \
		source/MainWindow.cpp \
		source/OpenGL_App_QT.cpp \
		source/Point3d.cpp moc_MainWindow.cpp
OBJECTS       = GLcamera.o \
		GLwidget.o \
		MainWindow.o \
		OpenGL_App_QT.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		3dS_01_2.pro include/GLcamera.h \
		include/GLwidget.h \
		include/MainWindow.h \
		include/Point3d.h source/GLcamera.cpp \
		source/GLwidget.cpp \
		source/MainWindow.cpp \
		source/OpenGL_App_QT.cpp \
		source/Point3d.cpp
QMAKE_TARGET  = 3dS_01_2
DESTDIR       = 
TARGET        = 3dS_01_2
...
Makefile: 3dS_01_2.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/GLcamera.h include/GLwidget.h include/MainWindow.h include/Point3d.h $(DISTDIR)/
...
moc_MainWindow.cpp: include/GLwidget.h \
		include/Point3d.h \
		include/GLcamera.h \
		include/MainWindow.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/anaeijon/Dropbox/Workspaces/3D_Scanning/Exercise_1 -I/usr/include/qt -I/usr/include/qt/QtOpenGL -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/7.2.0 -I/usr/include/c++/7.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/7.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/7.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/7.2.0/include-fixed -I/usr/include include/MainWindow.h -o moc_MainWindow.cpp
...
GLcamera.o: source/GLcamera.cpp include/GLcamera.h \
		include/Point3d.h \
		GLFW/glfw3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o GLcamera.o source/GLcamera.cpp
...
MainWindow.o: source/MainWindow.cpp include/MainWindow.h \
		include/GLwidget.h \
		include/Point3d.h \
		include/GLcamera.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MainWindow.o source/MainWindow.cpp

OpenGL_App_QT.o: source/OpenGL_App_QT.cpp include/MainWindow.h \
		include/GLwidget.h \
		include/Point3d.h \
		include/GLcamera.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o OpenGL_App_QT.o source/OpenGL_App_QT.cpp
